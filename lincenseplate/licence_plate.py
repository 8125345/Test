...
base_dir = Path('/Users/clustar/Desktop/项目/车牌识别/车牌照片/total')
null_xml_list = []
...
def CopyandRenameimg():
    save_image = Path('/Users/clustar/Desktop/项目/车牌识别/车牌照片/img')
...
def batchxml2txt():
    with open('/Users/clustar/Desktop/项目/车牌识别/车牌照片/data.txt', 'w+') as f:
...
def splitdata():
    with open('/Users/clustar/Desktop/项目/车牌识别/车牌照片/data.txt', 'r') as f:
        lines = f.readlines()
        print(len(lines))
        # print(lines)
        ratio = 0.9
