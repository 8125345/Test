...
json_file = '/Users/clustar/Desktop/项目/金盛兰数据_超长/精品废钢超长最新/test/test.json'
output = '/Users/clustar/Desktop/项目/金盛兰数据_超长/精品废钢超长最新/test/yolo_test'
...
def generate_all_txt():
    imagelist = glob('/Users/clustar/Desktop/项目/金盛兰数据_超长/精品废钢超长最新/train/image/*')
    with open('/Users/clustar/Desktop/项目/金盛兰数据_超长/精品废钢超长最新/train/train.txt', 'w') as fp:
        for img in imagelist:
            fp.write(img.replace() + '\n')
